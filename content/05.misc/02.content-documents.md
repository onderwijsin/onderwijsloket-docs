...
- [Paragraphs](https://docs.scalar.com/editor#/guides/undefined)
...
ButtonsCalloutsImagesContent listsRelated content listsMediaplayersMentions
...
_A component showing customisable and actionable lists._ _Contains a many-to-one relation to the collection&#x20;_`content_list_items`.
...
_An inline mention-like reference to another content item in the system. Mentions are mainly used to prevent the need for static&#x20;_`/path`_&#x20;references when using internal links. Currently, these related collections can be ‘mentioned’ (more might be added in the future, so make sure your implementation is forwards compatible):_

- `articles`

In contrast to _relation block&#x20;_&#x6E;odes, the relation inline block in not necessarily a top-level node, but usually a child of a _paragraph&#x20;_&#x6E;ode:
...
You can also find all editor node definitions in the code snippets repo:\
<https://github.com/onderwijsin/onderwijsloket-examples/blob/main/src/editor-nodes.ts>
...
You can also find this function, along with related examples, in our code snippets repository:\
<https://github.com/onderwijsin/onderwijsloket-examples/blob/main/src/inject-data.ts>
...
As HTMLAs EditorBring your own3rd party tools
