...
| `aroundLatLng`   | The center point for the search, formatted as "latitude,longitude"    |
| `aroundRadius`   | Optional radius (in meters) to limit results                          |
| `getRankingInfo` | Returns ranking metadata such as the distance from the query location |
...
| `area_center` | Geographic centroid of the region                     |
| `area_bounds` | Polygon representing the outer boundary of the region |
| `area_inner`  | Coordinate grid covering the region                   |
