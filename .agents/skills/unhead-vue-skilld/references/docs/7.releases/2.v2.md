...
Traditionally frameworks like React, Vue and Angular have left it up to their respective ecosystems to solve this problem. Vue had Vue Meta and VueUse Head and
React had and continues to have React Helmet.

We see some frameworks shifting towards providing simple support as part of their core, such as in React v19
and in Angular v14.
...
Unhead started out humbly 5 years ago as `@vueuse/head`. Since then it's joined
...
**Rewritten Core**: With the core being rewritten, optimizations were done
